...
// Le indicamos que esta clase interactua con la base de datos
@Repository
public class ProductoRepository implements ProductRepository {
    // IoC Inversión de control
    // Se le sede el control generalmente a un framework
    @Autowired
    ...
    public Optional<List<Product>> getByCategory(int categoryId) {
        List<Producto> productos = productoCrudRepository.findByIdCategoriaOrderByIdCategoriaAsc(categoryId);
    ...
    public Product save(Product product) {
        ...
        producto.setCodigoBarras("agregaElCodigo");
